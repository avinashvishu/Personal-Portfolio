...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'>V Avinash  <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                  fill="none"
        ...
        <p className='home__description'>I'm a highly skilled and motivated Full Stack Developer with extensive expertise in programming, developing, and maintaining web applications. I excel in both front-end and back-end technologies, consistently delivering robust, user-friendly, and responsive solutions. My passion lies in remaining abreast of the latest technologies and implementing best practices to engineer innovative software solutions.
